...
const ParticipantOverlay: React.FC<ParticipantOverlayProps> = ({
  isOpen,
  onClose,
  onAddParticipant,
  contractId,
                ...
                <VStack spacing={4}>
                    ...
                    {names.map((name, index) => (
                      <ListItem key={index}>
                        <HStack justify="space-between">
                          ...
                          <CloseButton
                            onClick={() =>
                              handleRemoveParticipant(index, 'userName')
                            }
                          />
                        </HStack>
                      </ListItem>
                  ...
                  <HStack>
                    ...
                    <IconButton
                      ...
                      aria-label="Add Name"
                      onClick={() =>
                        handleAddParticipant(nameInput, 'userName')
                      }
                    />
                  </HStack>
                </VStack>
                ...
                <VStack spacing={4}>
                    ...
                    {emails.map((email, index) => (
                      <ListItem key={index}>
                        <HStack justify="space-between">
                          ...
                          <CloseButton
                            onClick={() =>
                              handleRemoveParticipant(index, 'email')
                            }
                          />
                        </HStack>
                      </ListItem>
                  ...
                  <HStack>
                    ...
                    <IconButton
                      ...
                      onClick={() => handleAddParticipant(emailInput, 'email')}
                    />
                  </HStack>
                </VStack>
              </TabPanel>
                ...
                <VStack spacing={4}>
                    ...
                    {ids.map((id, index) => (
                      <ListItem key={index}>
                        <HStack justify="space-between">
                          <Box>{id}</Box>
                          <CloseButton
                            onClick={() => handleRemoveParticipant(index, 'id')}
                          />
                        </HStack>
                      </ListItem>
                    ))}
                  ...
                  <HStack>
                    ...
                    <IconButton
                      ...
                      icon={<AddIcon />}
                      aria-label="Add ID"
                      onClick={() => handleAddParticipant(idInput, 'id')}
                    />
                  </HStack>
                </VStack>
              </TabPanel>
